...
iterator entries[A, B](t: Table[A, B]): Entry[A, B] =
  ...
  var
    root = t.root
    currentEntry: Entry[A, B]
    stack = newSeq[Entry[A, B]]()
...
iterator mentries[A, B](t: var Table[A, B]): var Entry[A, B] =
  ...
  var
    root = unsafeAddr t.root
    currentEntry: ptr Entry[A, B]
    stack = newSeq[ptr Entry[A, B]]()
